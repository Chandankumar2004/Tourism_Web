...
export function Hero() {
  ...
  return (
    <section className="relative h-[80vh] min-h-[500px] max-h-[700px] w-full flex items-center justify-center text-white">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[rgba(15,54,54,0.75)] to-[rgba(0,0,0,0.4)] z-10"></div>
      ...
      <div className="relative z-20 text-center px-4">
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-[#E0F2F2]" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.7)' }}>
